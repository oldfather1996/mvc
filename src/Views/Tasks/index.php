...
<div class="row col-md-12 centered">
    <table class="table table-striped custab">
        ...
        foreach ($tasks as $task) {
            ...
            echo "<td class='text-center'><a class='btn btn-info btn-xs' href='/mvc/tasks/edit/" .
                $task["id"] . "' ><span class='glyphicon glyphicon-edit'></span> Edit</a> <a href='/mvc/tasks/delete/" .
